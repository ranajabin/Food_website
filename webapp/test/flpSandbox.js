		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#customerappcustomerodataapp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"customerappcustomerodataapp-display": {
								"semanticObject": "customerappcustomerodataapp",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=customerapp.customerodataapp",
									"url": sap.ui.require.toUrl("customerapp/customerodataapp")
								}
							}
						}
					}
